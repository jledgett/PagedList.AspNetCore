...
Expand-Archive -Path nupkg/PagedList.AspNetCore.10.0.11.nupkg -DestinationPath nupkg/inspect -Force
...
From the repo root
```shell
dotnet nuget push nupkg/PagedList.AspNetCore.10.0.11.nupkg --api-key YOUR_API_KEY --source https://api.nuget.org/v3/index.json
```

Or with the environment variable:

```shell
dotnet nuget push nupkg/PagedList.AspNetCore.10.0.11.nupkg --api-key $env:NUGET_API_KEY --source https://api.nuget.org/v3/index.json
```
